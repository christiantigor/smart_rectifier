						...
						function($scope, MainSvc, $mdDialog, $interval) {
							...
							var refresh = function() {
								...
								retrieve($scope, $mdDialog, false, MainSvc
									...
									data.push({
										name : "Supply Modem 6.5V",
										value : datas.srMdm0,
										symbol : "V",
										def : 6.5
									});
									data.push({
										name : "Supply Modem 13.5V",
										value : datas.srMdm1,
										symbol : "V",
										def : 13.5
									});
									data.push({
										name : "Supply Modem 19.5V",
										value : datas.srMdm2,
										symbol : "V",
										def : 19.5
									});
									data.push({
										name : "Supply Modem 24V",
										value : datas.srMdm3,
										symbol : "V",
										def : 24
									});
									data.push({
										name : "Supply Modem 12V",
										value : datas.srSCADA,
										symbol : "V",
										def : 12
									});
									data.push({
										name : "Supply Modem SCPC",
										value : datas.srSCPC,
										symbol : "V",
										def : 48
									});
									data.push({
										name : "Supply Modem BUC",
										value : datas.srBUC,
										symbol : "V",
										def : 48
									});
