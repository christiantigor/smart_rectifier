  ...
  PluginController.prototype = {
    ...
    hide: function (okBtn) {
      if (okBtn) {
        ...
        if(this.params.ngChange) {
        	this.params.ngChange({time:this.currentDate});
        }
      } else {
        this._dialog.cancel();
      }
      
      this.openFrom[0].parentElement.className = this.openFrom[0].parentElement.className
		.replace('md-input-focused', '');
    }
  };
